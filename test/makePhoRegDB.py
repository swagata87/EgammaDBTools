...
if era=="2017":
    ...
    regres_dir = "/mercury/data1/harper/EgEnergyRegression/EgRegresTrainer/resultsPhoV5/"
    regres_data = [
        {"filename" : "regPhoEcal2017UL_IdealIC_IdealTraining_stdVar_stdCuts_{region}_ntrees1500_results.root", "dbLabel" : "photon_{region_lower}_ecalOnly_5To300_0p2To2_mean","fileLabel" : "{region}Correction"},
        {"filename" : "regPhoEcal2017UL_RealIC_RealTraining_stdVar_stdCuts_{region}_ntrees1500_results.root", "dbLabel" : "photon_{region_lower}_ecalOnly_5To300_0p0002To0p5_sigma","fileLabel" : "{region}Uncertainty"},
        ]
elif era=="2018":
    ...
    regres_dir = "/mercury/data1/harper/EgEnergyRegression/EgRegresTrainer/resultsPhoV5/"
    regres_data = [
        {"filename" : "regPhoEcal2018UL_IdealIC_IdealTraining_stdVar_stdCuts_{region}_ntrees1500_results.root", "dbLabel" : "photon_{region_lower}_ecalOnly_5To300_0p2To2_mean","fileLabel" : "{region}Correction"},
        {"filename" : "regPhoEcal2018UL_RealIC_RealTraining_stdVar_stdCuts_{region}_ntrees1500_results.root", "dbLabel" : "photon_{region_lower}_ecalOnly_5To300_0p0002To0p5_sigma","fileLabel" : "{region}Uncertainty"},
        ]
